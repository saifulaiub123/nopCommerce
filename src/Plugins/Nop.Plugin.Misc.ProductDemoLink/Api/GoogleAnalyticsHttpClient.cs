...
public class GoogleAnalyticsHttpClient
{
    ...
    public async Task RequestAsync(EventRequest request, ProductDemoLinkSettings googleAnalyticsSettings)
    {
        ...
        try
        {
            ...
            var uri = QueryHelpers.AddQueryString(googleAnalyticsSettings.UseSandbox ? ProductDemoLinkDefaults.EndPointDebugUrl : ProductDemoLinkDefaults.EndPointUrl, query);
