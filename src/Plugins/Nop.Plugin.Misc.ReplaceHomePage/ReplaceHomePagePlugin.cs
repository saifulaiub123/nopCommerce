...
/// </summary>
public class ReplaceHomePagePlugin : BasePlugin, IAdminMenuPlugin, IMiscPlugin
{
    #region Fields
    ...
    public ReplaceHomePagePlugin(IPermissionService permissionService,
    ...
    {
        return $"{_webHelper.GetStoreLocation()}Admin/ReplaceHomePage/Configure";
    }
    ...
    public async Task ManageSiteMapAsync(SiteMapNode rootNode)
    {
        ...
        {
            SystemName = "Replace home page plugin",
            Title = "Replace Home Page",
            ControllerName = "ReplaceHomePage",
