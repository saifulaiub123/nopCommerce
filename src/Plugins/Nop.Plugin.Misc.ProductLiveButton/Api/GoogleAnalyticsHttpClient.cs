...
public class GoogleAnalyticsHttpClient
{
    ...
    public async Task RequestAsync(EventRequest request, ProductLiveButtonSettings googleAnalyticsSettings)
    {
        //configure client
        try
        {
            ...
            var uri = QueryHelpers.AddQueryString(googleAnalyticsSettings.UseSandbox ? ProductLiveButtonDefaults.EndPointDebugUrl : ProductLiveButtonDefaults.EndPointUrl, query);
